...
// Derived summary stats — computed so they stay in sync with raw data automatically
...
// Precompute max revenue once so getBarHeight doesn't scan the array on every call
...
const loadData = async () => {
  ...
  error.value = null
  try {
    // Fetch both endpoints in parallel — sequential fetching is slower
